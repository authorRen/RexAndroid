...
public class JsonUtil {
    ...
    /**
     * 将JSONObject对象转换成相应的类对象
     */
    public static <T> T decode(JSONObject jsonObject, Type typeOfT) {
        if (jsonObject == null) {
            return null;
        }
        return decode(jsonObject.toString(), typeOfT);
    }
